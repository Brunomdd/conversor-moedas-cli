...
def ver_historico():
    ...
    for item in historico:
        print()
        print(f"Moeda origem: {item['valor_origem']}".center(32))
        print(f"Moeda destino: {item['valor_destino']}".center(32))
    ...
    while True:
        ...
        if opcao == 1:
            ...
            if resposta:
                ...
                lista.append({'Origem':origem,'destino':destino,"valor_conversão":valor,"valor_convertido":resposta})
                salvar(lista)
        elif opcao == 2:
            moedas_disponiveis()
        elif opcao == 3:
